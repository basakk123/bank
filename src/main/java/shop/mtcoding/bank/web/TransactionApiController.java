...
public class TransactionApiController {
    ...
    public ResponseEntity<?> withdraw(@PathVariable Long userId, WithdrawReqDto withdrawReqDto) {
        WithdrawRespDto withdrawRespDto = transactionService.출금하기(userId, withdrawReqDto);
        return new ResponseEntity<>(new ResponseDto<>("출금성공", null), HttpStatus.CREATED);
    }
}
